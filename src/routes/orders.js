...
const { createOrder, getMyOrders, getAllOrders, updateOrderStatus, getDashboardStats, regenerateInvoice, regenerateAllInvoices, updateOrderTimestamp, downloadInvoice, assignCustomQRToOrder } = require("../controllers/orderController");
