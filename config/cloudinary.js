...
if (process.env.CLOUDINARY_URL) {
  try {
    ...
    console.warn("⚠️ Falling back to individual variables or missing config");
  }
  ...
  console.warn("⚠️ Cloudinary configuration missing. Please set CLOUDINARY_URL or CLOUDINARY_NAME, CLOUDINARY_KEY, CLOUDINARY_SECRET");
}
